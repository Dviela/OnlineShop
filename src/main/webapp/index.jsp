...
<html lang="en" data-bs-theme="auto">
  <head><script src="/docs/5.3/assets/js/color-modes.js"></script>
    ...
    <meta name="author" content="Alberto Navarro y Daniel Viela">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          <h4>Welcome</h4>
          <p class="text-body-secondary">Welcome to OnlineShop</p>
        </div>
...
<footer class="text-body-secondary py-5">
  <div class="container">
    ...
    <p class="mb-1">OnlineShop. Management program for online stores.</p>
    <p class="mb-0">OnlineShop is a registered trademark</a>.</p>
  </div>
</footer>
